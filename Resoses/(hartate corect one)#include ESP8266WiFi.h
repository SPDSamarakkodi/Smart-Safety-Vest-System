...
static unsigned long lastHeartPrint = 0;

// Read sensor FIRST every loop
long irValue = particleSensor.getIR();

// Debug every second
if (millis() - lastHeartPrint > 1000)
{
    lastHeartPrint = millis();
...
// Process heartbeat continuously
else
{
